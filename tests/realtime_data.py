        ...
        'MHIDE': (
            ...
            [
                dm.StationLine(
                    ...
                    destination_time=35100,
                    direction='Southbound',
                    due_in=9,
                    late=5,
                    location_type=dm.LocationType.STOP,
                    status='En Route',
                    scheduled_arrival=33720,
                    scheduled_depart=33780,
                    expected_arrival=33720,
                    expected_depart=34020,
                ...
                dm.StationLine(
                    ...
                    destination_time=36360,
                    direction='Northbound',
                    due_in=52,
                    late=1,
                    location_type=dm.LocationType.DESTINATION,
                    status='En Route',
                    scheduled_arrival=36360,
                    scheduled_depart=None,
                    expected_arrival=36420,
                    expected_depart=None,
                ...
                dm.StationLine(
                    ...
                    scheduled_depart=37440,
                    expected_arrival=None,
                    expected_depart=37440,
                    train_type=dm.TrainType.DART,
                    last_location=None,
                ),
                dm.StationLine(
                    ...
                    destination_code='BRAY',
                    destination_name='Bray',
                    destination_time=40500,
                    direction='Northbound',
                    due_in=81,
                    late=-1,
                    location_type=dm.LocationType.STOP,
                    status='No Information',
                    scheduled_arrival=38100,
                    scheduled_depart=38280,
                    expected_arrival=38100,
                    expected_depart=38340,
                    train_type=dm.TrainType.DMU,
                    last_location=None,
                ),
            ],
            ...
            datetime.date(2025, 6, 29): (
                ...
                _TRAIN_OBJ_QUERY,
                {
                    1: dm.TrainStop(
                        ...
                        departure=34224,
                        scheduled_arrival=None,
                        scheduled_depart=34200,
                        expected_arrival=None,
                        expected_depart=34200,
                    ),
                    2: dm.TrainStop(
                        query=_TRAIN_OBJ_QUERY,
                        auto_arrival=True,
                        ...
                        arrival=34392,
                        departure=34470,
                        scheduled_arrival=34410,
                        scheduled_depart=34440,
                        expected_arrival=34434,
                        expected_depart=34422,
                    ),
                    3: dm.TrainStop(
                        query=_TRAIN_OBJ_QUERY,
                        auto_arrival=True,
                        ...
                        arrival=34536,
                        departure=34614,
                        scheduled_arrival=34560,
                        scheduled_depart=34590,
                        expected_arrival=34590,
                        expected_depart=34566,
                    ),
                    4: dm.TrainStop(
                        query=_TRAIN_OBJ_QUERY,
                        auto_arrival=True,
                        ...
                        arrival=38586,
                        departure=38706,
                        scheduled_arrival=38670,
                        scheduled_depart=38730,
                        expected_arrival=38694,
                        expected_depart=38646,
                    ),
                    5: dm.TrainStop(
                        query=_TRAIN_OBJ_QUERY,
                        auto_arrival=False,
                        ...
                        arrival=None,
                        departure=None,
                        scheduled_arrival=38790,
                        scheduled_depart=38790,
                        expected_arrival=38766,
                        expected_depart=38766,
                    ),
                    6: dm.TrainStop(
                        query=_TRAIN_OBJ_QUERY,
                        auto_arrival=True,
                        ...
                        arrival=38994,
                        departure=39018,
                        scheduled_arrival=39060,
                        scheduled_depart=39060,
                        expected_arrival=39036,
                        expected_depart=38994,
                    ),
                    7: dm.TrainStop(
                        query=_TRAIN_OBJ_QUERY,
                        auto_arrival=True,
                        ...
                        arrival=39306,
                        departure=None,
                        scheduled_arrival=39300,
                        scheduled_depart=None,
                        expected_arrival=39258,
                        expected_depart=None,
                    ),
                },
            ),
...
+------+-------+-------------------------------------------------+-----------------+---------------+----------+
|  64  |  BRAY |                       Bray                      |        ∅        |  51°52′7.68″N | 51.8688  |
|      |       |                                                 |                 |  8°19′27.01″W | -8.32417 |
+------+-------+-------------------------------------------------+-----------------+---------------+----------+
...
|      |       |                                                 |                 |       ∅       |    ∅     |
+------+-------+-------------------------------------------------+-----------------+---------------+----------+
|  66  |  COBH |                       Cobh                      |        ∅        | 51°50′56.76″N | 51.8491  |
|      |       |                                                 |                 |  8°17′58.42″W | -8.29956 |
+------+-------+-------------------------------------------------+-----------------+---------------+----------+
| 1519 | MOIRA |                      MOIRA                      |  Dublin Belfast |       ∅       |    ∅     |
|      |       |                                                 |                 |       ∅       |    ∅     |
+------+-------+-------------------------------------------------+-----------------+---------------+----------+
| 228  | MHIDE | Malahide with extra looooooooooooooooooong name |        ∅        | 54°36′44.28″N | 54.6123  |
|      |       |                                                 |                 |  5°55′2.78″W  | -5.91744 |
+------+-------+-------------------------------------------------+-----------------+---------------+----------+\
"""
...
+---------+---------------+-------------------+------------------+-------------------+------------------+
|    #    |      Stop     | Arrival (Expect.) | Arrival (Actual) | Depart. (Expect.) | Depart. (Actual) |
+---------+---------------+-------------------+------------------+-------------------+------------------+
|    1    |     MHIDE     |         ∅         |     09:19:24     |      09:30:00     |     09:30:24     |
|         |    Malahide   |         ⚙         |                  |         ⚙         |                  |
|         |     ORIGIN    |                   |                  |                   |                  |
+---------+---------------+-------------------+------------------+-------------------+------------------+
|    2    |      COBH     |      09:33:30     |     09:33:12     |      09:34:00     |     09:34:30     |
|         |      Cobh     |      09:33:54     |                  |      09:33:42     |                  |
|         |       ■       |         ⚙         |                  |         ⚙         |                  |
+---------+---------------+-------------------+------------------+-------------------+------------------+
|    3    |     GRGRD     |      09:36:00     |     09:35:36     |      09:36:30     |     09:36:54     |
|         |  Clongriffin  |      09:36:30     |                  |      09:36:06     |                  |
|         |       ■       |         ⚙         |                  |         ⚙         |                  |
+---------+---------------+-------------------+------------------+-------------------+------------------+
|    4    |      BRAY     |      10:44:30     |     10:43:06     |      10:45:30     |     10:45:06     |
...
|         |       ⏱       |                   |                  |                   |                  |
+---------+---------------+-------------------+------------------+-------------------+------------------+
|    6    |     MOIRA     |      10:51:00     |     10:49:54     |      10:51:00     |     10:50:18     |
|         |      ????     |      10:50:36     |                  |      10:49:54     |                  |
|         |       ⏱       |         ⚙         |                  |         ⚙         |                  |
+---------+---------------+-------------------+------------------+-------------------+------------------+
|    7    |      BRAY     |      10:55:00     |     10:55:06     |         ∅         |        ∅         |
